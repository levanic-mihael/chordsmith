...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(chordName) =>
      "Jeste li sigurni da želite izbrisati \"${chordName}\"?";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "alternativeChordSaved": MessageLookupByLibrary.simpleMessage(
      "Alternativni akord je spremljen.",
    ),
    "alternativeChords": MessageLookupByLibrary.simpleMessage(
      "Alternativni akordi",
    ),
    ...
    "customChordSaved": MessageLookupByLibrary.simpleMessage(
      "Prilagođeni akord je spremljen.",
    ),
    ...
    "editChord": MessageLookupByLibrary.simpleMessage("Uredi akord"),
    "editChords": MessageLookupByLibrary.simpleMessage("Uredi akorde"),
    "editCustomChord": MessageLookupByLibrary.simpleMessage(
      "Uredi prilagođeni akord",
    ),
    "enterChordNameHint": MessageLookupByLibrary.simpleMessage("Naziv akorda"),
    "enterCustomChordName": MessageLookupByLibrary.simpleMessage(
      "Unesite naziv prilagođenog akorda",
    ),
    ...
    "selectChordToCreateAlternative": MessageLookupByLibrary.simpleMessage(
      "Odaberite akord za izradu alternative:",
    ),
    "selectChordType": MessageLookupByLibrary.simpleMessage(
    ...
    "showChord": MessageLookupByLibrary.simpleMessage("Prikaži akord"),
    "standard": MessageLookupByLibrary.simpleMessage("Standardno"),
    "standardChordNotFound": MessageLookupByLibrary.simpleMessage(
      "Standardni akord nije pronađen.",
    ),
    "standardChords": MessageLookupByLibrary.simpleMessage("Standardni akordi"),
    "thisChord": MessageLookupByLibrary.simpleMessage("ovaj akord"),
